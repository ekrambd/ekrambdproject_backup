...
<div class="wrapper">
    ...
    <ul class="navbar-nav ml-auto mb-2">
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{URL::to('/logout')}}" role="button">
          <img class="img-fluid logout-image" src="{{asset('public/images/logged2.jfif')}}"> 
        </a>
      </li>
    </ul>
  </nav>
  ...
  <aside class="main-sidebar sidebar-light-primary elevation-4">
    ...
    <a href="{{URL::to('/dashboard')}}" class="brand-link">
     ...
     @if(strlen(setting()->app_name) > 28)
      <span class="brand-text font-weight-light"><marquee>{{setting()->app_name}}</marquee></span>
     @else
      <span class="brand-text font-weight-light text-center">{{setting()->app_name}}</span>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="image">
            ...
            <img src="{{asset('public/images/dummy-profile-pic.png')}}" class="img-circle elevation-2 profile-pic" alt="User Image">
        ...
        @else
         <div class="image">
            ...
            <img src="{{URL::to(Auth::user()->image)}}" class="img-circle elevation-2 profile-pic" alt="User Image">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{URL::to('tips')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>All Tips</p>
                </a>
              </li>
          ...
          <li class="nav-item" id="setting-link">
            <a href="#" class="nav-link">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{URL::to('/app-settings')}}" class="nav-link" id="app-settings">
                  <i class="far fa-circle nav-icon"></i>
                  <p>App Settings</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{URL::to('/account-settings')}}" class="nav-link" id="account-settings">
                  <i class="far fa-circle nav-icon"></i>
              ...
              <li class="nav-item">
                <a href="{{URL::to('/change-password')}}" class="nav-link" id="change-password">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Change Password</p>
                </a>
              </li>
